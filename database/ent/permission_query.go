...
func (pq *PermissionQuery) FirstID(ctx context.Context) (id uint16, err error) {
	var ids []uint16
...
func (pq *PermissionQuery) FirstIDX(ctx context.Context) uint16 {
...
func (pq *PermissionQuery) OnlyID(ctx context.Context) (id uint16, err error) {
	var ids []uint16
...
func (pq *PermissionQuery) OnlyIDX(ctx context.Context) uint16 {
...
func (pq *PermissionQuery) IDs(ctx context.Context) (ids []uint16, err error) {
...
func (pq *PermissionQuery) IDsX(ctx context.Context) []uint16 {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *PermissionQuery) loadRoles(ctx context.Context, query *RoleQuery, nodes []*Permission, init func(*Permission), assign func(*Permission, *Role)) error {
	...
	byID := make(map[uint16]*Permission)
	nids := make(map[uint8]map[*Permission]struct{})
	...
	qr := QuerierFunc(func(ctx context.Context, q Query) (Value, error) {
		return query.sqlAll(ctx, func(_ context.Context, spec *sqlgraph.QuerySpec) {
			...
			spec.Assign = func(columns []string, values []any) error {
				outValue := uint16(values[0].(*sql.NullInt64).Int64)
...
func (pq *PermissionQuery) loadRolePermission(ctx context.Context, query *RolePermissionQuery, nodes []*Permission, init func(*Permission), assign func(*Permission, *RolePermission)) error {
	...
	nodeids := make(map[uint16]*Permission)
	for i := range nodes {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(rolepermission.FieldPid)
	}
...
func (pq *PermissionQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(permission.Table, permission.Columns, sqlgraph.NewFieldSpec(permission.FieldID, field.TypeUint16))
	_spec.From = pq.sql
