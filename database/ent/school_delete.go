...
func (sd *SchoolDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, SchoolMutation](ctx, sd.sqlExec, sd.mutation, sd.hooks)
}
...
func (sd *SchoolDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(school.Table, sqlgraph.NewFieldSpec(school.FieldID, field.TypeUint16))
